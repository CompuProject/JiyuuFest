<?php
/**
 * Description of AP_EditCommentsEdit
 *
 * @author olga
 */
class AP_CommentsEdit  extends AdminPanel_ComponentPanelUI_Element_Edit {
    ...
    protected function setDefaltInput() { 
        ...
        $this->insertValue['parentFeedback'] = $this->feedbackData['parentFeedback'];
