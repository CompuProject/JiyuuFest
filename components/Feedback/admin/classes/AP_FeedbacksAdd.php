<?php
/**
 * Description of AP_EditFeedbacksAdd
 *
 * @author olga
 */
class AP_FeedbacksAdd extends AdminPanel_ComponentPanelUI_Element_Add {
...
//        $this->insertValue['fio'] = parent::getOriginalPostValue('fio');
        ...
        $this->insertValue['rating'] = parent::getOriginalPostValue('rating');
