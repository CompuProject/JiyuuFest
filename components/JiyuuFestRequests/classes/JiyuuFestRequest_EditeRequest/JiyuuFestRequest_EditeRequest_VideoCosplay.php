<?php
/**
 * Description of JiyuuFestRequest_EditeRequest_VideoCosplay
 *
 * @author maxim
 */
class JiyuuFestRequest_EditeRequest_VideoCosplay extends JiyuuFestRequest_EditeRequest {
    ...
    protected function generateFormInputElementsHtml() {
        ...
        // video
        $video = parent::getFileUrl('video')."<div>".$this->inputHelper->loadFiles('video', 'video', 'video', false, false, $this->mimeType['video'])."</div>";
