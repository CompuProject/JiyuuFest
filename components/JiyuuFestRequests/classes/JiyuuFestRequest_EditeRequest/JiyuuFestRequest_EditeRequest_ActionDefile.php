<?php
/**
 * Description of JiyuuFestRequest_EditeRequest_ActionDefile
 *
 * @author maxim
 */
class JiyuuFestRequest_EditeRequest_ActionDefile extends JiyuuFestRequest_EditeRequest {
    ...
    protected function mysqlInsertOthersData() {
        $query = "UPDATE `JiyuuFestRequest_ActionDefile` SET ";
