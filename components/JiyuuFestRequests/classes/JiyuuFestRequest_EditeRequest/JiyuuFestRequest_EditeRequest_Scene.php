<?php
/**
 * Description of JiyuuFestRequest_EditeRequest_Scene
 *
 * @author maxim
 */
class JiyuuFestRequest_EditeRequest_Scene extends JiyuuFestRequest_EditeRequest {
    ...
    protected function generateFormInputElementsHtml() {
        ...
        $demo_audition = parent::getFileUrl('demo')."<div>".$demo."</div><div>".$audition." ".$this->localization->getText("audition")."</div>";
        ...
        $audio_instrumental_audioInVideo = parent::getFileUrl('audio')."<div>".$audio."</div>".
        ...
        $video_noVideo = parent::getFileUrl('video')."<div>".$video."</div><div>".$noVideo." ".$this->localization->getText("noVideo")."</div>";
        ...
        // scenario
        $scenario = parent::getFileUrl('scenario')."<div>".$this->inputHelper->loadFiles('scenario', 'scenario', 'scenario', false, false, $this->mimeType['doc'])."</div>";
