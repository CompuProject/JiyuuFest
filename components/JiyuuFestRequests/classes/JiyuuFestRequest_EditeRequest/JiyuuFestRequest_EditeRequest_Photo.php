...
//        $photo4 = $this->downloadFileHelper->getFileName();
        ...
        $this->downloadImageHelper->uploadFile('photo1', 'photo1', null, null, '15MB',null,1920,1080,'placedIn');
        $this->downloadImageHelper->makeMiniature('photo1_s', 200, 200, 'placedIn');
        $photo1 = $this->downloadImageHelper->getFileName();
        
        $this->downloadImageHelper->uploadFile('photo2', 'photo2', null, null, '15MB',null,1920,1080,'placedIn');
        $this->downloadImageHelper->makeMiniature('photo2_s', 200, 200, 'placedIn');
        $photo2 = $this->downloadImageHelper->getFileName();
        
        $this->downloadImageHelper->uploadFile('photo3', 'photo3', null, null, '15MB',null,1920,1080,'placedIn');
        $this->downloadImageHelper->makeMiniature('photo3_s', 200, 200, 'placedIn');
        $photo3 = $this->downloadImageHelper->getFileName();
        
        $this->downloadImageHelper->uploadFile('photo4', 'photo4', null, null, '15MB',null,1920,1080,'placedIn');
