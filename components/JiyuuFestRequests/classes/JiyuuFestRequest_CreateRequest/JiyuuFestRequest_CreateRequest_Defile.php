<?php
/**
 * Description of JiyuuFestRequest_CreateRequest_Defile
 *
 * @author maxim
 */
class JiyuuFestRequest_CreateRequest_Defile extends JiyuuFestRequest_CreateRequest {
    ...
    protected function mysqlInsertOthersData() {
        $query = "INSERT INTO `JiyuuFestRequest_Defile` SET ";
