 ...
 * @author maxim
 */
class JiyuuFestRequest_CreateRequest_AMV extends JiyuuFestRequest_CreateRequest {
    ...
    protected function generateFormInputElementsHtml() {
        ...
        // amv
        $amv = $this->inputHelper->loadFiles('amv', 'amv', 'amv', false, false, $this->mimeType['video']);
    ...
    protected function mysqlInsertOthersData() {
        $query = "INSERT INTO `JiyuuFestRequest_AMV` SET ";
